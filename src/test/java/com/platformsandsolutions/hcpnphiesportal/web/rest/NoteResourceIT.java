...
import com.platformsandsolutions.hcpnphiesportal.repository.NoteRepository;
...
class NoteResourceIT {
    ...
    public static Note createEntity(EntityManager em) {
        Note note = new Note().text(DEFAULT_TEXT).author(DEFAULT_AUTHOR).time(DEFAULT_TIME);
        return note;
    }
    ...
    public static Note createUpdatedEntity(EntityManager em) {
        Note note = new Note().text(UPDATED_TEXT).author(UPDATED_AUTHOR).time(UPDATED_TIME);
        return note;
    }
    ...
    void putNewNote() throws Exception {
        ...
        updatedNote.text(UPDATED_TEXT).author(UPDATED_AUTHOR).time(UPDATED_TIME);
    ...
    void fullUpdateNoteWithPatch() throws Exception {
        ...
        partialUpdatedNote.text(UPDATED_TEXT).author(UPDATED_AUTHOR).time(UPDATED_TIME);
