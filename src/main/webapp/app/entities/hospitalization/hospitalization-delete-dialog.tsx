...
export const HospitalizationDeleteDialog = (props: IHospitalizationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.hospitalization.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.hospitalization.delete.question" interpolate={{ id: hospitalizationEntity.id }}>
          Are you sure you want to delete this Hospitalization?
        </Translate>
      </ModalBody>
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-hospitalization" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
