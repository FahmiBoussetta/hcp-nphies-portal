...
export const AttachmentDeleteDialog = (props: IAttachmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.attachment.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.attachment.delete.question" interpolate={{ id: attachmentEntity.id }}>
