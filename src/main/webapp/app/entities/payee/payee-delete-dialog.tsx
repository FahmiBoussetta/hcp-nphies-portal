...
export const PayeeDeleteDialog = (props: IPayeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.payee.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.payee.delete.question" interpolate={{ id: payeeEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-payee" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
