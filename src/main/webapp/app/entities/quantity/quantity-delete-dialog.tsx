...
export const QuantityDeleteDialog = (props: IQuantityDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.quantity.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.quantity.delete.question" interpolate={{ id: quantityEntity.id }}>
