...
export const ContactDeleteDialog = (props: IContactDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.contact.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.contact.delete.question" interpolate={{ id: contactEntity.id }}>
