...
export const InsuranceDeleteDialog = (props: IInsuranceDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.insurance.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.insurance.delete.question" interpolate={{ id: insuranceEntity.id }}>
