...
export const TaskOutputDeleteDialog = (props: ITaskOutputDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.taskOutput.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.taskOutput.delete.question" interpolate={{ id: taskOutputEntity.id }}>
          Are you sure you want to delete this TaskOutput?
        </Translate>
      </ModalBody>
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-taskOutput" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
