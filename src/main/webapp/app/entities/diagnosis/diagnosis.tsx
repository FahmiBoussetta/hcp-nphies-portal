  ...
  return (
    <div>
      <h2 id="diagnosis-heading" data-cy="DiagnosisHeading">
        <Translate contentKey="hcpNphiesPortalApp.diagnosis.home.title">Diagnoses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hcpNphiesPortalApp.diagnosis.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hcpNphiesPortalApp.diagnosis.home.createLabel">Create new Diagnosis</Translate>
          </Link>
        </div>
      </h2>
        ...
        {diagnosisList && diagnosisList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hcpNphiesPortalApp.diagnosis.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {diagnosisList.map((diagnosis, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`hcpNphiesPortalApp.DiagnosisTypeEnum.${diagnosis.type}`} />
                  </td>
                  <td>
                    <Translate contentKey={`hcpNphiesPortalApp.DiagnosisOnAdmissionEnum.${diagnosis.onAdmission}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hcpNphiesPortalApp.diagnosis.home.notFound">No Diagnoses found</Translate>
            </div>
          )
        )}
      </div>
