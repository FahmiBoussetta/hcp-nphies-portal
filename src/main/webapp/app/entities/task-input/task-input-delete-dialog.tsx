...
export const TaskInputDeleteDialog = (props: ITaskInputDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.taskInput.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.taskInput.delete.question" interpolate={{ id: taskInputEntity.id }}>
          Are you sure you want to delete this TaskInput?
        </Translate>
      </ModalBody>
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-taskInput" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
