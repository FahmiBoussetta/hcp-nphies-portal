...
export const TaskResponseDeleteDialog = (props: ITaskResponseDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.taskResponse.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.taskResponse.delete.question" interpolate={{ id: taskResponseEntity.id }}>
