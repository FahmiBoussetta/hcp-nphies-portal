  ...
  return (
    <div>
      <h2 id="information-sequence-heading" data-cy="InformationSequenceHeading">
        <Translate contentKey="hcpNphiesPortalApp.informationSequence.home.title">Information Sequences</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hcpNphiesPortalApp.informationSequence.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hcpNphiesPortalApp.informationSequence.home.createLabel">Create new Information Sequence</Translate>
          </Link>
        </div>
      </h2>
        ...
        {informationSequenceList && informationSequenceList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hcpNphiesPortalApp.informationSequence.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hcpNphiesPortalApp.informationSequence.home.notFound">No Information Sequences found</Translate>
            </div>
          )
        )}
      </div>
