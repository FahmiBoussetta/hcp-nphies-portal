...
export const ClassComponentDeleteDialog = (props: IClassComponentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.classComponent.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.classComponent.delete.question" interpolate={{ id: classComponentEntity.id }}>
