...
export const TotalDeleteDialog = (props: ITotalDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.total.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.total.delete.question" interpolate={{ id: totalEntity.id }}>
          Are you sure you want to delete this Total?
        </Translate>
      </ModalBody>
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-total" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
