...
export const ComErrorMessagesDeleteDialog = (props: IComErrorMessagesDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.comErrorMessages.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.comErrorMessages.delete.question" interpolate={{ id: comErrorMessagesEntity.id }}>
          Are you sure you want to delete this ComErrorMessages?
        </Translate>
      </ModalBody>
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-comErrorMessages" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
