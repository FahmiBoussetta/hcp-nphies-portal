...
export const PractitionerDeleteDialog = (props: IPractitionerDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.practitioner.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.practitioner.delete.question" interpolate={{ id: practitionerEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-practitioner" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
