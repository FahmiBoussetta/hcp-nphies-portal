  ...
  return (
    <div>
      <h2 id="list-specialty-enum-heading" data-cy="ListSpecialtyEnumHeading">
        <Translate contentKey="hcpNphiesPortalApp.listSpecialtyEnum.home.title">List Specialty Enums</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hcpNphiesPortalApp.listSpecialtyEnum.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hcpNphiesPortalApp.listSpecialtyEnum.home.createLabel">Create new List Specialty Enum</Translate>
          </Link>
        </div>
      </h2>
        ...
        {listSpecialtyEnumList && listSpecialtyEnumList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hcpNphiesPortalApp.listSpecialtyEnum.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {listSpecialtyEnumList.map((listSpecialtyEnum, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`hcpNphiesPortalApp.SpecialtyEnum.${listSpecialtyEnum.s}`} />
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hcpNphiesPortalApp.listSpecialtyEnum.home.notFound">No List Specialty Enums found</Translate>
            </div>
          )
        )}
      </div>
