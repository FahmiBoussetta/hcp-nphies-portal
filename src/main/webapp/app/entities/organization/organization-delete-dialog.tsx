...
export const OrganizationDeleteDialog = (props: IOrganizationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalApp.organization.delete.question">
        <Translate contentKey="hcpNphiesPortalApp.organization.delete.question" interpolate={{ id: organizationEntity.id }}>
